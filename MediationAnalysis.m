...
pdm = multivariateMediation(xx_cat,yy,mm_cell, 'B', 20, 'svd', 'plots');

varRetained = pdm.dat.M_tilde*pdm.dat.Dt;
sum(var(varRetained)/size(mm, 2))

cd('..\Results')
pdm2 = multivariateMediation(pdm, 'nPDM', 4, 'svd', 'bootPDM', 'Bsamp', 5000, 'save2file', 'multimedBootResults_cat.mat', 'returnbootsamples');
