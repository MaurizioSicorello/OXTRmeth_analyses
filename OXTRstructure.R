...
corrplot::corrplot(CpG_corr_k, tl.pos = "n", tl.cex = 0.25, method = "color", type = "upper", tl.col = "black")
dev.off()

# combined corrplot
pdf(here("Figures", "corrPlot_combined.pdf"))
par(mfrow=c(1,2))
corrplot::corrplot(CpG_corr, tl.pos = "lt", tl.cex = 0.25, method = "color", type = "upper", tl.col = "black", title = "Mothers")
corrplot::corrplot(CpG_corr_k, tl.pos = "lt", tl.cex = 0.25, method = "color", type = "upper", tl.col = "black", title = "Children")
dev.off()
